...
import { Phone, Mail, Thermometer, Layers, Zap, DollarSign, Home, CheckCircle, ArrowRight } from 'lucide-react'
...
export default function BlownInInsulationPage() {
  return (
    <div className="bg-gray-50">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center justify-center text-white overflow-hidden bg-cover bg-center" style={{backgroundImage: 'url(/images/attic.webp)', paddingTop: 'calc(100px + 5rem)'}}>
