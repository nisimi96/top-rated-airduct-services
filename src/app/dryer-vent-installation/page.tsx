...
import { Phone, Mail, Hammer, ShieldAlert, CheckCircle, Construction, Ruler, ArrowRight } from 'lucide-react'
...
export default function DryerVentInstallationPage() {
  return (
    <div className="bg-gray-50">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center justify-center text-white overflow-hidden bg-cover bg-center" style={{backgroundImage: 'url(/images/clean-dryer.webp)', paddingTop: 'calc(100px + 5rem)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-20">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-4 max-w-4xl mx-auto">
              ...
              {/* After - Clean/New */}
              <div className="flex-1 text-center">
                <p className="text-sm font-bold text-brand-blue mb-3 uppercase tracking-wide">After Installation</p>
                <div className="rounded-2xl overflow-hidden shadow-lg h-64 md:h-80 bg-white">
                  <img
